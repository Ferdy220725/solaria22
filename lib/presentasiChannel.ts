...
export type PresentasiEvent =
  ...
  | { type: "state_sync"; slide: number; totalPages: number; blank?: boolean; zoom?: number } // balasan dari layar utama
  ...
  | { type: "zoom"; scale: number } // dikirim HP: skala zoom slide (1 = normal, >1 = diperbesar)
